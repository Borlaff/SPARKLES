...
Following a previous study `(Horiuchi et al. 2020) <https://ui.adsabs.harvard.edu/abs/2020ApJ...905....3H/abstract>`, we assumed :math:`T_{\oplus}= 290` K for the temperature of Earth and a surface temperature :math:`T_{\rm{sat}}= 280\pm3` K for satellites. Ground-based measurements estimated that the optical and near-infrared albedoes can vary between 0.1 and 0.5 for LEO satellites `(Horiuchi et al. 2023, <http://adsabs.harvard.edu/cgi-bin/nph-data_query?link_type=ABSTRACT&bibcode=2023PASJ...75..584H>`_ `Tyson et al. 2024) <http://adsabs.harvard.edu/cgi-bin/nph-data_query?link_type=ABSTRACT&bibcode=2024ApJ...966L..38T>`_, even higher (:math:`p ≈ 1`) for small pieces of debris. For the purpose of this study, we assumed a uniform distribution for :math:`p` in the range [0.1–0.5].
